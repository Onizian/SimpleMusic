...
public class SongListInfo extends LitePalSupport implements Serializable {
    private long id;
    ...
    private MusicListInfo musicListInfo;//与musiclistinfo多对一关系
    ...
    public MusicListInfo getMusicListInfo() {
        return musicListInfo;
    }

    public void setMusicListInfo(MusicListInfo musicListInfo) {
